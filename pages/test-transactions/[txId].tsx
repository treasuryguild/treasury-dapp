...
function TestTxid() {
  ...
  async function checkTransactionType() {
    if (connected) { 
      ...
      const totalAmountsString = formatTotalAmounts(totalAmounts, txdata.walletTokens);
      ...
      for (let month in monthly_budget_balance) {
          monthly_budget_balance_strings[month] = formatTotalAmounts(monthly_budget_balance[month], txdata.walletTokens);
      }
